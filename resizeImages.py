...
for path, subdirnames, filenames in os.walk("C:\\Users\\poona\\Downloads\\FaceRecognition-master\\FaceRecognition-master\\templates\\trainingImages"):
    ...
    for filename in filenames:
      ...
      new_path="C:\\Users\\poona\\Downloads\\FaceRecognition-master\\FaceRecognition-master\\templates\\resizedTrainingImages"+"/"+str(id)
